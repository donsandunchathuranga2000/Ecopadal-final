...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void addMarkers(GoogleMap googleMap) {
        ...
        googleMap.addMarker(new MarkerOptions().position(colombo).title("Uni junction-2").icon(customMarker));
        ...
        googleMap.addMarker(new MarkerOptions().position(colombo2).title("Police Park-1").icon(customMarker2));
        ...
        googleMap.addMarker(new MarkerOptions().position(havlock).title("Havlock-3").icon(customMarker3));
        ...
        googleMap.addMarker(new MarkerOptions().position(kirulapone).title(" Kirulapone-5").icon(customMarker4));
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(kirulapone, 18));

        LatLng Nugegoda= new LatLng(6.864462772090605, 79.8982353680496);
        BitmapDescriptor customMarker5= BitmapDescriptorFactory.fromResource(R.drawable.bikerent);
        googleMap.addMarker(new MarkerOptions().position(Nugegoda).title(" Nugegoda-4").icon(customMarker5));
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(kirulapone, 18));

        LatLng Maharagama= new LatLng(6.851224022477399, 79.92105339114624);
        BitmapDescriptor customMarker6= BitmapDescriptorFactory.fromResource(R.drawable.bikerent);
        googleMap.addMarker(new MarkerOptions().position(Maharagama).title(" Maharagama-1").icon(customMarker6));
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(kirulapone, 18));
    }
